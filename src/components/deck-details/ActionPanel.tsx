...
export function ActionPanel({
  ...
  return (
    <div className="flex flex-wrap gap-2 mb-6" role="toolbar" aria-label="Akcje dla talii">
      ...
      {onAddFlashcard && (
        <Button variant="outline" onClick={onAddFlashcard} disabled={isLoading} aria-label="Wygeneruj fiszki">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
      ...
      {onAddManualFlashcard && (
        <Button variant="outline" onClick={onAddManualFlashcard} disabled={isLoading} aria-label="Dodaj fiszkę">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
